  ...
  return (
    <div className="w-full max-w-lg mx-auto py-12 flex flex-col items-center">
       ...
       <div className="relative w-full flex flex-col items-center gap-8">
          ...
          <div className="absolute top-0 bottom-0 w-[2px] bg-gradient-to-b from-transparent via-[#15604E]/60 to-transparent z-0">
             {/* Falling Particle */}
             <div className="w-full h-full absolute inset-0 overflow-hidden rounded-full">
               <motion.div 
                 animate={{ y: ["-100%", "400%"] }}
                 transition={{ duration: 2.5, repeat: Infinity, ease: "linear" }}
                 className="w-full h-[30%] bg-gradient-to-b from-transparent via-[#15604E] to-transparent shadow-[0_0_15px_#15604E]"
               />
             </div>
          </div>
          ...
          <motion.div 
            ...
            className="relative z-10 w-full max-w-[340px] bg-gradient-to-r from-[#111111] to-[#161616] border border-[#15604E]/40 rounded-2xl p-5 flex items-center gap-5 shadow-[0_0_40px_rgba(21,96,78,0.2)] backdrop-blur-xl"
          >
             <div className="w-14 h-14 rounded-xl bg-[#15604E]/10 border border-[#15604E]/30 flex items-center justify-center relative overflow-hidden">
                <BrainCircuit className="w-7 h-7 text-[#15604E] relative z-10" />
                {/* Rotating background effect */}
                <motion.div 
                  animate={{ rotate: 360 }}
                  transition={{ duration: 4, repeat: Infinity, ease: "linear" }}
                  className="absolute inset-[-50%] bg-gradient-to-tr from-transparent via-[#15604E]/20 to-transparent"
                />
             </div>
             <div>
                <div className="text-white font-bold text-base tracking-tight">AI Engine</div>
                <div className="text-[#15604E] text-xs font-mono mt-1 animate-pulse font-medium tracking-wide">Executing Logic...</div>
             </div>
          </motion.div>
