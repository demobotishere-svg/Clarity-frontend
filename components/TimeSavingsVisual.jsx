    ...
    <div className="w-full max-w-lg mx-auto py-8 lg:py-12">
      <div className="flex flex-col gap-4 sm:gap-6">
        ...
        <motion.div 
          ...
          className="relative bg-gradient-to-r from-[#111111] to-[#15604E]/15 border border-[#15604E]/40 rounded-2xl p-4 sm:p-5 flex items-center gap-4 sm:gap-6 overflow-hidden shadow-[0_10px_40px_rgba(21,96,78,0.2)] backdrop-blur-xl"
        >
           <div className="w-10 h-10 sm:w-12 sm:h-12 shrink-0 rounded-xl bg-[#15604E]/20 border border-[#15604E]/50 flex items-center justify-center shadow-[0_0_20px_rgba(21,96,78,0.6)]">
              <Zap className="w-5 h-5 sm:w-6 sm:h-6 text-[#15604E]" />
           </div>
           
           <div className="w-24 sm:w-36 shrink-0">
              <div className="text-[#15604E] font-mono text-[9px] sm:text-[10px] uppercase tracking-[0.15em] mb-1 font-bold">The Blueprint</div>
           ...
           <div className="flex-1 h-[2px] relative bg-[#15604E]/30 rounded-full overflow-hidden">
              <motion.div 
                 ...
                 className="w-1/2 h-full bg-[#15604E] shadow-[0_0_12px_#15604E]"
              />
           </div>
        </motion.div>
