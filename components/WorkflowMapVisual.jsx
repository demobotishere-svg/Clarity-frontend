    ...
    <div className="w-full aspect-[4/3] max-w-lg mx-auto relative rounded-[2rem] border border-white/10 bg-[#0a0a0a] overflow-hidden flex flex-col p-4 sm:p-6 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
       ...
       <div className="relative flex-1 w-full h-full mt-4">
         ...
         <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
            ...
            <circle r="4" fill="#15604E" className="drop-shadow-[0_0_8px_#15604E]">
         ...
         <motion.div 
           ...
           className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 bg-[#15604E]/10 border border-[#15604E]/50 rounded-xl p-3 sm:p-4 shadow-[0_0_40px_rgba(21,96,78,0.25)] flex flex-col gap-3 w-40 sm:w-48 z-10 backdrop-blur-xl"
         >
            <div className="flex items-center gap-3">
               <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-[#15604E] flex items-center justify-center shrink-0 shadow-[0_0_15px_#15604E]">
                  <Bot className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
               </div>
               <div>
                  <div className="text-white font-bold text-xs sm:text-sm leading-tight">AI Agent</div>
                  <div className="text-[#15604E] text-[9px] sm:text-[10px] font-mono animate-pulse mt-0.5">Processing...</div>
               </div>
            </div>
            ...
            <div className="w-full h-1.5 bg-black/50 rounded-full overflow-hidden border border-white/5">
               <motion.div 
                  ...
                  className="h-full bg-[#15604E] shadow-[0_0_10px_#15604E]"
               />
            </div>
         </motion.div>
