  ...
  return (
    <div className="w-full max-w-2xl mx-auto py-10 md:py-14">
      <div className="relative flex items-center justify-between px-6 sm:px-16">
        {/* Connecting Line */}
        <div className="absolute top-1/2 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-[#15604E]/40 to-transparent -translate-y-1/2" />
        ...
        <div className="absolute top-1/2 left-0 w-full h-[2px] -translate-y-1/2 overflow-hidden pointer-events-none">
           <motion.div 
             ...
             className="w-1/4 h-full bg-gradient-to-r from-transparent via-[#15604E] to-transparent shadow-[0_0_10px_#15604E]"
           />
        </div>
        ...
        >
           <div className="w-10 h-10 rounded-full bg-[#15604E]/10 flex items-center justify-center border border-[#15604E]/30">
               <Zap className="w-4 h-4 text-[#15604E]" />
           </div>
        </motion.div>
        ...
        <motion.div 
          ...
          className="relative z-10 flex flex-col items-center"
        >
          <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-[#111111] border border-[#15604E]/40 flex items-center justify-center shadow-[0_0_50px_rgba(21,96,78,0.2)] relative overflow-hidden group backdrop-blur-sm">
             <div className="absolute inset-0 bg-[#15604E]/10 group-hover:bg-[#15604E]/20 transition-colors" />
             <Network className="w-8 h-8 sm:w-10 sm:h-10 text-[#15604E]" />
          ...
          <span className="mt-5 font-mono text-[10px] sm:text-xs text-[#15604E] uppercase tracking-[0.2em] font-bold">Live System</span>
        </motion.div>
